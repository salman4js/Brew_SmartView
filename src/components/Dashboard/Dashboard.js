...
const Dashboard = () => {
    ...
    async function batchesApi() {
        ...
        setLoader(true);
        const average = await getRoomList(splitedIds[0], {getWidgetTileCollection: true, getUserCollection: true}); // true here indicates that the preferences has be fetched.
